...
public class TutOven extends BlockContainer
{
	...
	{
		this.blockIcon = iR.registerIcon(Strings.modid + ":" + "tutOvenSide");
		this.iconFront = iR.registerIcon(Strings.modid + ":" + (this.isActive ? "tutOvenFrontOn" : "tutOvenFrontOff"));
		this.iconTop = iR.registerIcon(Strings.modid + ":" + "tutOvenTop");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if(!world.isRemote)
		{
			FMLNetworkHandler.openGui(player, TutorialMod.instance, TutorialMod.guiIDTutOven, world, x, y, z);
		}
		return true;
	}
